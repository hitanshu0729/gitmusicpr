...
// <!-- Add the following code inside the existing <script> tag -->
document.getElementById("loginButton").addEventListener('click', () => {
    // Display a confirmation dialog
    const logoutConfirmation = confirm("Do you want to logout?");

    // Check the user's choice
    if (logoutConfirmation) {
        // If the user clicks "OK" (yes), then redirect to localhost:3000/login
        window.location.href = 'http://localhost:3000/login';
    } else {
        // If the user clicks "Cancel" (no), do nothing or perform another action
        // For example, you can add code here to handle the "no" case
